...
D1_CACHE = 'cache/d1_concat_embeddings.pkl'
QUERY_CONCAT_CACHE = 'cache/query_concat_embeddings.pkl'
...
if os.path.exists(D1_CACHE):
    ...
    d1_kw_list = [x.get('Q_keywords', []) for x in d1]
...
keywords_list = [item.get('query_keywords', []) for item in data]
