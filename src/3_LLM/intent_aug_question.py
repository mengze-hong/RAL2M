...
parser.add_argument("--input_file", type=str, default="../../data/D1.jsonl")
parser.add_argument("--output_file", type=str, default="D1_intent.jsonl")
...
def generate_keywords_batch(batch_rows):
    prompts = [KEYWORD_PROMPT_TEMPLATE.format(user_query=r['Q']) for r in batch_rows]
    ...
    for i, out in enumerate(outputs):
        ...
        keywords = extract_clean_intent(generated_text)
...
with open(args.input_file, "r", encoding="utf-8") as f:
    ...
    for line in tqdm(lines, desc="Processing"):
        ...
        if item.get("id") in processed_ids: continue
