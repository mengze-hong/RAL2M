...
parser.add_argument("--input_file", type=str, default="judgement_results/final_results_new_with_bge.jsonl")
parser.add_argument("--output_file", type=str, default="judgement_results/ral2m_aug1.jsonl")
    ...
    for line in tqdm(f, desc="Judging retrieval"):
        ...
        if len(batch) >= args.batch_size:
            ...
            for row, jud in zip(batch, judgements):
                row = row.copy()
                row["qwen_judge_retrieval_without_role_aug"] = jud
