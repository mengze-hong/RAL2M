# llm_rejudge_retrieval_with_mistral8.py
...
parser.add_argument("--output_file", type=str, default="judgement_results/ral2m_aug_mistral.jsonl")
...
print("加载 mistral2.5-7B-Instruct...")
