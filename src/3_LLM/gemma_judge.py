# llm_rejudge_retrieval_with_gemma.py
...
parser.add_argument("--input_file", type=str, default="judgement_results/new_results_updated_new_new.jsonl")
parser.add_argument("--output_file", type=str, default="judgement_results/new_results_updated_new_new_new.jsonl")
    ...
    for line in tqdm(f, desc="Judging retrieval"):
        ...
        if len(batch) >= args.batch_size:
            ...
            for row, jud in zip(batch, judgements):
                row = row.copy()
                row["gemma_judge_retrieval_without_role"] = jud
