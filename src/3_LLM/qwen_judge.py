...
parser.add_argument("--input_file", type=str, default="judgement_results/new_results_updated.jsonl")
parser.add_argument("--output_file", type=str, default="judgement_results/new_results_updated_new.jsonl")
    ...
    for line in tqdm(f, desc="Judging retrieval"):
        ...
        if len(batch) >= args.batch_size:
            ...
            for row, jud in zip(batch, judgements):
                row = row.copy()
                row["qwen_judge_retrieval_without_role"] = jud
